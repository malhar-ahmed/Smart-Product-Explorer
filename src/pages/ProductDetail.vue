  ...
  <div class="max-w-6xl mx-auto pb-20">
    ...
    <button
      ...
      class="mb-8 flex items-center gap-2
             ...
             font-bold group transition-colors"
    >
      <span
    ...
    >
      ...
      <div
        class="flex-1 space-y-6 pt-10"
      >
        <div
          class="h-12 bg-slate-200
                 dark:bg-slate-800
                 rounded-2xl w-3/4"
        ></div>

        <div
          class="h-32 bg-slate-200
                 dark:bg-slate-800
                 rounded-2xl w-full"
        ></div>
      </div>
        ...
        >
          ...
          >
            <button
              ...
              :class="[
                'w-24 h-24 rounded-2xl p-3 border-2 transition-all shrink-0 bg-white dark:bg-slate-900',
